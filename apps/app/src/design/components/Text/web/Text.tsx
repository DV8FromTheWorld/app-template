...
export function Text({
  ...
  if (id != null) elementProps.id = id;
  if (ariaLabel != null) elementProps['aria-label'] = ariaLabel;
  if (ariaDescribedBy != null) elementProps['aria-describedby'] = ariaDescribedBy;
  if (htmlFor != null && Tag === 'label') elementProps.htmlFor = htmlFor;
